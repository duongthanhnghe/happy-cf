...
import { getAllOrder, getOrderById, createOrder, deleteOrder, getAllStatus, getAllPayment, getOrdersByUserId, updateOrderStatus, getRewardHistoryByUserId, checkPoint, sepayCallback, getShippingFee, } from '../controllers/orderController.js';
const router = Router();
