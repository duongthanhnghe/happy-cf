...
import { getAllOrder, getOrderById, createOrder, deleteOrder, getAllStatus, getAllPayment, getOrdersByUserId, updateOrderStatus, getRewardHistoryByUserId, checkPoint, 
// payWithSepay,
sepayCallback, } from '../controllers/orderController.js';
const router = Router();
