...
import { getAllProductReviews, getProductReviewById, updateProductReviewStatus, deleteProductReview, submitProductReview, getReviewsByUser, getReviewsByProduct, } from '../../controllers/v1/productReviewController.js';
const router = Router();
