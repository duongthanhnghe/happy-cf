...
import { getAllPosts, getPostsById, createPosts, updatePosts, deletePosts, getPostsLatest, toggleActive, getPostsByCategory, getPostBySlug, getRelatedPostsBySlug, updateView, getAllPostsPagination, } from '../../controllers/v1/postNewsController.js';
const router = Router();
