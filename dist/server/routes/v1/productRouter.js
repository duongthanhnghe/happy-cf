...
import { getAllProduct, getProductById, createProduct, updateProduct, deleteProduct, getPromotionalProducts, getMostOrderedProduct, getWishlistByUserId, addWishlistItem, deleteWishlistItem, toggleActive, searchProducts, getRelatedProducts, } from '../../controllers/v1/productController.js';
const router = Router();
