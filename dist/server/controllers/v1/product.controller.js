...
export const getAllActiveCategoryIds = async () => {
...
export const filterActiveVariantGroupsForProduct = async (product) => {
...
export const filterActiveVariantGroupsForProducts = async (products) => {
    if (!products.length)
        return products;
...
export const getPromotionalProducts = async (req, res) => {
    ...
    try {
        ...
        if (req.query.categoryId) {
            ...
            const ids = ((_a = categories[0]) === null || _a === void 0 ? void 0 : _a.ids) || [categoryId];
            const allActive = await getAllActiveCategoryIds();
            activeCategories = ids.filter(id => allActive.some(a => a.equals(id)));
            if (!(activeCategories === null || activeCategories === void 0 ? void 0 : activeCategories.length)) {
                return res.json({
                    code: 0,
                    data: [],
...
export const getProductsByCategory = async (req, res) => {
    ...
    try {
        ...
        let sortQuery = { updatedAt: -1, _id: 1 }; // default
        switch (sort) {
            case "price_desc":
                sortQuery = { price: -1, _id: 1 };
                break;
