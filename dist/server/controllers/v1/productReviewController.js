...
import { toProductReviewDTO, toProductReviewListDTO } from "../../mappers/v1/productReviewMapper.js";
import { ProductEntity } from "../../models/v1/ProductEntity.js";
...
export const getReviewsByProduct = async (req, res) => {
    try {
        ...
        // tính average
        const sumRatings = summaryAgg.reduce((acc, cur) => acc + cur._id * cur.count, 0);
