...
var script = /*@__PURE__*/ defineComponent({
    ...
    setup(__props) {
         ...
         */
        onMounted(() => {
            htmlLayerInstance = new HtmlVideoLayer(videoRef.value, props.cldVid, props.sources, props.plugins, undefined, props.cldPoster, { useFetchFormat: props.useFetchFormat });
        });
        /**
         * On update, we cancel running plugins and update image instance with the state of user
