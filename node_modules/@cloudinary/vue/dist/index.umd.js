(function (global, factory) {
  ...
  var script = /*@__PURE__*/ vue.defineComponent({
      ...
      props: {
          ...
          useFetchFormat: { type: Boolean, required: false }
      },
      setup(__props) {
          const props = __props;
           ...
           */
          vue.onMounted(() => {
              htmlLayerInstance = new html.HtmlVideoLayer(videoRef.value, props.cldVid, props.sources, props.plugins, undefined, props.cldPoster, { useFetchFormat: props.useFetchFormat });
          });
          /**
           * On update, we cancel running plugins and update image instance with the state of user
