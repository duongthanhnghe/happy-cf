...
const listPolicy = [
    {
      label: t('product.detail.policy1').text,
      icon: 'reset_exposure',
    },
    {
      label: t('product.detail.policy2').text,
      icon: 'delivery_truck_speed',
    },
    {
      label: t('product.detail.policy3').text,
      icon: 'phone_in_talk',
    },
    {
      label: t('product.detail.policy4').text,
      icon: 'box',
    },
  ]
</script>
