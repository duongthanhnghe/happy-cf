...
<template>
  <div v-if="getFlashSaleDetail" class="rd-lg pd-0 bg-four overflow-hidden mt-sm" :style="`background-color: ${getFlashSaleDetail.theme.backgroundColor} !important`">
    <Image 
      v-if="getFlashSaleDetail.banners.length > 0"
    ...
    <div class="pd-ms">
      ...
      <Card v-if="getFlashSaleDetail.description" bg="white" class="rd-md mt-sm">
        <Text :text="getFlashSaleDetail.name" color="black" weight="semibold" size="normal" />
        <Text :text="getFlashSaleDetail.description" class="white-space-pre line-height-1d8" />
