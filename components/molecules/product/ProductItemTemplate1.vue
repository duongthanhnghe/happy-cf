  ...
  <div class="product-template1-image">
    ...
    <div v-else>
      <div v-if="storeCart.getTemplate1Amount(product.id) < 1">
        <Button v-if="product.options.length > 0" color="primary" size="xs" class="product-template1-plus" @click="storeProduct.getProductDetailApi(product.id)">
      ...
      <div v-else>
        <div v-if="product.options.length > 0" class="product-template1-plus product-template1-plus-number" @click="storeProduct.getProductDetailApi(product.id)">
