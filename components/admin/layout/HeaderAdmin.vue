...
import '@/styles/admin/layout/header.scss'
...
<template>
  <client-only>
  <div :class="['header-admin-bg',slotLeft && !storeDisplay.isLaptop ? 'height-header-admin-filter':'height-header-admin']">
    <div 
      class="header-admin transition-0d3 position-fixed top-0 right-0 width-full z-index-11" 
      ...
      >
        ...
        <div 
          ...
          !storeDisplay.isLaptop ? 'bottom-0 left-0 width-full position-absolute bg-gray6 pd-sm overflow-auto-x scroll-hide border-top-default':'',
          headerLeftClass
        ]">
