...
export const ordersAPI = {
  ...
  //     const response = await fetch(`${apiConfig.adminApiURL}${API_ENDPOINTS_ADMIN.ORDERS.CREATE}`, {
  //       method: 'POST',
  ...
  //   try {
  //     const response = await fetch(`${apiConfig.adminApiURL}${API_ENDPOINTS_ADMIN.ORDERS.LIST_BY_USER(userId)}`)
  //     const data = await response.json()
  //     return data
  //   } catch (err) {
